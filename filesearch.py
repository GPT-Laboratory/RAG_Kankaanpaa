...
AZURE_API_VERSION = "**"
AZURE_ENDPOINT = "**"
MODEL_ENGINE = "gpt-4o-mini" # "gpt-4o-mini" for azure, "gpt-4o-mini" for openai, Note: changing the model will NOT update existing assistants
OPENAI_API_KEY = "**"
VECTOR_STORE_MAX_BATCH_SIZE = 500
VECTOR_STORE_NAME = "Documents of the city council of Kankaanpaa (Kaupunginhallitus and Kaupunginvaltuusto)"
ASSISTANT_NAME = "City council of Kankanpaa assistant"
ASSISTANT_INSTRUCTIONS = "You are an secretary for the city council. Use your knowledge base to answer questions about events, topics, discussions and decissions made in the city council. Answer only based on the given files. If the requested information does not exist in the files, report that information is not available. Answer in the language of the user query. ALWAYS include file citations."
